...
fileprivate enum Constants {
    static var dropdownFontSize: CGFloat = 14

    static var getDropdownFontSize: CGFloat {
        return Constants.dropdownFontSize
    }
}

extension View {

    func getDropdownFontSize() -> CGFloat {
        return Constants.dropdownFontSize
    }
    ...
    ///   - font: The font of the text. Default is a system font of size 14 and regular weight.
